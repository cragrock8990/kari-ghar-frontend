...
export class AppService {
  getProfessions() {
    return [
      { name: 'Plumber', code: 'PLB', icon: 'plumber.svg' },
      { name: 'Electrician', code: 'ELC', icon: 'electrician.svg' },
      { name: 'Builder', code: 'BLD', icon: 'builder.svg' },
      { name: 'Carpenter', code: 'CRP', icon: 'carpenter.svg' },
      { name: 'Labor', code: 'LBR', icon: 'labor.svg' },
      { name: 'Painter', code: 'PNT', icon: 'painter.svg' },
      { name: 'Gardner', code: 'KRC', icon: 'gardner.svg' },
    ];
  }
  getProductsData() {
    return [
